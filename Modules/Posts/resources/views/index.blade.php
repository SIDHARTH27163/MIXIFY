<x-home-layout>
    <div class=" lg:px-5 font-poppins max-w-7xl mx-auto my-5 pb-5">
      @if (session('success'))
    ...
    @endif
      <div class="dark:bg-gray-900 lg:p-5 p-2 rounded-lg flex flex-col md:flex-row gap-4 dark:text-white text-black">
        ...
        <div class=" flex-1 p-1">
                  ...
                  <div class="flex flex-wrap gap-10 w-full max-md:max-w-full  justify-between">
                    <div class="flex flex-1 gap-2">
                      ...
                      <div class="flex flex-col my-auto">
                        <div class="flex gap-1 text-sm font-bold text-zinc-700 dark:text-zinc-300">
          ...
          <div class=" lg:w-96 md:w-96 w-full mx-auto p-4">
              <div class="w-full flex flex-col gap-y-2 h-96 overflow-y-auto scrollbar p-2">
                  {{-- profile section --}}
