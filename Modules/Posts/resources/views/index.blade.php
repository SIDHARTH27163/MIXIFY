<x-home-layout>
    <div class="dark:bg-gray-900 font-poppins max-w-7xl mx-auto p-5  flex flex-col md:flex-row gap-4 dark:text-white text-black">
        ...
        <div class=" lg:w-96 md:w-96 w-96 mx-auto p-4">
            <div class="w-full flex flex-col gap-y-2">
                {{-- profile section --}}
                <div class="flex flex-col gap-4 shadow-lg rounded-lg bg-slate-950">
                ...
                <div class="flex flex-col gap-4 dark:bg-white bg-gray-800 rounded-lg shadow-xl">
                    <div class="flex items-center space-x-3 justify-between px-3 py-2 ">
                        <div class="flex gap-x-2">
                            <div class="flex-shrink-0">
                                <img
