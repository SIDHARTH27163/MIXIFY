...
@endif
        ...
        <h2 class="text-lg font-semibold mb-6 text-gray-800 dark:text-gray-100">Notification Settings</h2>
        ...
        <form method="POST" action="{{ route('settings.notifications.update') }}">
            ...
            <!-- Push Notifications -->
            <fieldset class="mb-6">
                <legend class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Push Notifications</legend>
    ...
    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email Notifications</label>
    <select name="email_notifications[]" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
       ...
       @endforeach
            ...
            <fieldset class="mb-6">
                <legend class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">In-App Notifications</legend>
                <div class="grid grid-cols-2 gap-4">
            ...
            <!-- Sound and Vibration -->
            <fieldset class="mb-6">
                <legend class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Sound and Vibration</legend>
                <div class="grid grid-cols-2 gap-4">
            ...
            <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Save Changes
            </button>
        </form>
    </div>
